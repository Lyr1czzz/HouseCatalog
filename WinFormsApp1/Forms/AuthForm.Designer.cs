namespace WinFormsApp1
{
    partial class AuthForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            registrButton.ColorFill_1 = Color.CornflowerBlue;
            ...
            registrButton.Location = new Point(341, 459);
            ...
            loginButton.ColorFill_1 = Color.CornflowerBlue;
            ...
            loginButton.Location = new Point(341, 459);
            ...
            registr_label.ForeColor = Color.White;
            registr_label.Location = new Point(350, 59);
            ...
            noacc_label.ForeColor = SystemColors.Control;
            ...
            backlabel.ForeColor = SystemColors.Control;
            ...
            Login.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            Login.ForeColor = Color.Black;
            Login.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            Login.Location = new Point(311, 180);
            Login.Margin = new Padding(3, 5, 3, 5);
            Login.Name = "Login";
            Login.PasswordChar = '\0';
            Login.PlaceholderForeColor = Color.Black;
            Login.PlaceholderText = "Введите свой логин";
            Login.SelectedText = "";
            Login.Size = new Size(286, 55);
            Login.TabIndex = 9;
            // 
            // Pass
            // 
            ...
            Pass.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            Pass.ForeColor = Color.Black;
            Pass.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            Pass.Location = new Point(311, 271);
            Pass.Margin = new Padding(3, 5, 3, 5);
            Pass.Name = "Pass";
            Pass.PasswordChar = '●';
            Pass.PlaceholderForeColor = Color.Black;
            Pass.PlaceholderText = "Введите пароль";
            Pass.SelectedText = "";
            Pass.Size = new Size(286, 55);
            Pass.TabIndex = 10;
            ...
            Repass.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            Repass.ForeColor = Color.Black;
            Repass.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            Repass.Location = new Point(311, 364);
            Repass.Margin = new Padding(3, 5, 3, 5);
            Repass.Name = "Repass";
            Repass.PasswordChar = '●';
            Repass.PlaceholderForeColor = Color.Black;
            Repass.PlaceholderText = "Повторите пароль";
            Repass.SelectedText = "";
            Repass.Size = new Size(286, 55);
            Repass.TabIndex = 11;
